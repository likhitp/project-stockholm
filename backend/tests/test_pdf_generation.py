...
import PyPDF2
from generate_test_docs import (
    create_directory,
...
class TestPDFGeneration(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        files_to_delete = ["employment_contract.pdf", "nda_agreement.pdf", "lease_agreement.pdf"]
    ...
    def test_file_creation(self):
        ...
        expected_files = ["employment_contract.pdf", "nda_agreement.pdf", "lease_agreement.pdf"]
    ...
    def test_pdf_structure(self):
        ...
        files_to_test = ["employment_contract.pdf", "nda_agreement.pdf", "lease_agreement.pdf"]
